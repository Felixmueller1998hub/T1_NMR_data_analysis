...
def HB_model(T, Delta_v_r, B, E_a, D, T_0):
...
filename = r'PEO_LiTSFI_13.1nofiller.xlsx'
...
# Fit the data
popt, pcov = curve_fit(HB_model, T, PW, p0=(6000, 1, 0.001617*250, 20, 200), maxfev = 10000, bounds=([4000,10**-9,0.01,1,0], [8000, 100, 1.0,200,300]))

# Extract the fitted parameters
Delta_v_r_fit, B_fit, E_a_fit, D_fit, T_0fit = popt
...
ax1.errorbar(T, PW, yerr=PW_error, fmt='o', label='Data', ecolor='gray',color = 'orange', capsize=5, elinewidth=2)
...
Delta_v_r_fit, B_fit, E_a_fit, D_fit, T_0_fit = popt
Delta_v_r_std, B_std, E_a_std, D_std, T_0_std = np.sqrt(np.diag(pcov))
...
print(f"T: {T_0_fit:.4f} ± {T_0_std:.4f}")